    ...
    <div className="border-b border-neutral-200 dark:border-dark-border">
          ...
          {VIEWS.map(view => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-1.5 min-h-11 px-3.5 py-2.5 text-sm font-bold whitespace-nowrap transition-colors border-b-2 ${
                  active
              ...
              >
                ...
                <span className="text-caption text-neutral-400 ml-0.5">({counts[view.countKey]})</span>
              </button>
            );
          })}
        </div>
        ...
        <div className="flex items-center gap-2 ml-auto sm:ml-0 pb-2 sm:pb-0">
          <div className="relative flex-1 sm:flex-none sm:w-44">
            ...
            <input
              ...
              className="w-full min-h-11 pl-9 pr-3 py-2.5 text-sm bg-neutral-50 dark:bg-dark-bg-tertiary border border-neutral-200 dark:border-dark-border rounded-xl focus:outline-none focus:border-primary transition-colors text-neutral-800 dark:text-dark-text"
            />
          </div>
          ...
          <select
            ...
            className="min-h-11 py-2.5 px-3 border border-neutral-200 dark:border-dark-border bg-neutral-50 dark:bg-dark-bg-tertiary text-sm rounded-xl font-medium focus:outline-none cursor-pointer text-neutral-800 dark:text-dark-text"
          >
          ...
          {currentView === "trash" && (
            <button
              ...
              className="min-h-11 py-2.5 px-3.5 bg-red-500 hover:bg-red-600 text-white font-bold rounded-xl text-sm flex items-center gap-1.5 active:scale-[0.98] transition-all shrink-0"
            >
      ...
      <div className="flex items-center gap-1.5 pb-2.5 overflow-x-auto scrollbar-hide">
        ...
        <button
          ...
          className={`min-h-10 px-3.5 py-2 rounded-full text-sm font-bold transition-colors shrink-0 ${
            !currentLabel
        ...
        {Object.keys(COLOR_SCHEMES).map(colorKey => {
          ...
          return (
            <button
              ...
              className={`min-h-10 px-3.5 py-2 rounded-full text-sm font-bold transition-colors flex items-center gap-1.5 shrink-0 ${
