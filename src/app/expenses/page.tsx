              ...
              {savedViews.map((view) => (
                ...
                >
                  <button
                    ...
                    className="min-h-10 px-3.5 py-2 text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                    {view.name}
                  </button>
                  <button
                    ...
                    className="touch-target px-3 text-gray-500 hover:text-red-500"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-3">
                        <select
                          ...
                          className="min-h-11 h-11 px-3 text-sm border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                        >
                          {PAYMENT_STATUS_VALUES.map((paymentStatus) => (
                            <option key={paymentStatus} value={paymentStatus}>
                              {getPaymentStatusLabel(paymentStatus)}
